...
const GenerateBtn = () => {
  ...
  return (
    <motion.div className='pb-16 text-center'
      ...
      viewport={{ once: true }}>
      <h1 className='text-2xl md:texxt-3xl lg:text-4xl mt-4 font-semibold text-neutral-800 py-6 md:py-16'>See the magic right now</h1>
      <button onClick={onClickHandler} className='inline-flex items-center gap-2 px-12 py-3 rounded-full bg-black text-white m-auto hover:scale-105 transition-all duration-500'>
        Generate image <img src={assets.star_group} alt="" className='h-6' /></button>
    </motion.div>
  )
}
